      ...
      <div className="relative w-full max-w-4xl bg-white/[0.02] backdrop-blur-2xl border border-[color-mix(in_srgb,var(--danger)_20%,transparent)] rounded-2xl p-12 shadow-md flex flex-col gap-8 overflow-hidden">
        ...
        <div className="flex items-start gap-8 relative z-10 text-left">
          ...
          <div className="flex flex-col gap-3 pt-2 flex-1">
            <h2 className="text-5xl font-black text-white tracking-tighter capitalize drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)] leading-none">{t("defcon_alert_title")}</h2>
            <h3 className="text-xl font-bold text-[var(--danger)] capitalize tracking-[0.3em] opacity-90 drop-shadow-md">{t("defcon_patch_detected")}</h3>
            <div className="w-full h-px bg-gradient-to-r from-[color-mix(in_srgb,var(--danger)_30%,transparent)] to-transparent my-3" />
            <p className="text-sm font-bold text-[var(--subtext)] leading-relaxed capitalize tracking-[0.15em] max-w-2xl opacity-80 whitespace-pre-line">
        ...
        {isBackingUp && (
          <div className="relative z-10 w-full mt-4 bg-[color-mix(in_srgb,var(--bg)_10%,transparent)] backdrop-blur-xl p-8 rounded-2xl border border-[color-mix(in_srgb,var(--danger)_10%,transparent)] flex flex-col gap-6 shadow-[inset_0_2px_20px_rgba(0,0,0,0.5)]">
            {backupProgress ? (
            <>
              <div className="flex justify-start items-end text-[11px] font-black capitalize tracking-[0.3em] text-[color-mix(in_srgb,var(--danger)_90%,transparent)] drop-shadow-md">
              ...
              <>
                <div className="flex justify-start items-end text-[11px] font-black capitalize tracking-[0.3em] text-[color-mix(in_srgb,var(--danger)_90%,transparent)]">
