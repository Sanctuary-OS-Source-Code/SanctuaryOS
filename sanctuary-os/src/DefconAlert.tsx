...
export function DefconAlert() {
  ...
  return (
    <div className="fixed inset-0 z-[9999999] flex flex-col items-center justify-center bg-[var(--bg)]/30 backdrop-blur-md animate-in fade-in duration-500 p-8">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-red-500/[10%] blur-[120px] pointer-events-none mix-blend-screen" />
      
      <div className="relative w-full max-w-4xl bg-white/[0.02] backdrop-blur-2xl border border-red-500/[20%] rounded-[var(--radius)] p-12 shadow-md flex flex-col gap-8 overflow-hidden">
        ...
        <div className="flex items-start gap-8 relative z-10 text-left">
          <div className="relative w-32 h-32 rounded-2xl bg-red-500/[5%] border border-red-500/[30%] flex items-center justify-center shrink-0 shadow-md">
          ...
          <div className="flex flex-col gap-3 pt-2 flex-1">
            ...
            <h3 className="text-xl font-bold text-[var(--danger)] uppercase tracking-[0.3em] opacity-90 drop-shadow-md">{t("defcon_patch_detected")}</h3>
        ...
        {isBackingUp && (
          <div className="relative z-10 w-full mt-4 bg-[var(--bg)]/10 backdrop-blur-xl p-8 rounded-2xl border border-red-500/[10%] flex flex-col gap-6 shadow-[inset_0_2px_20px_rgba(0,0,0,0.5)]">
            ...
            <>
              ...
              <div className="w-full bg-black/80 rounded-full h-3 overflow-hidden border border-red-500/[10%] shadow-[inset_0_2px_5px_rgba(0,0,0,0.8)]">
                <div 
              ...
              <>
                ...
                <div className="w-full bg-black/80 rounded-full h-3 overflow-hidden border border-red-500/[10%] shadow-[inset_0_2px_5px_rgba(0,0,0,0.8)]">
                  <div className="h-full w-full bg-red-500/[30%] relative">
        ...
        {!isBackingUp && (
          <div className="relative z-10 w-full mt-4 flex flex-col items-center justify-center gap-6 py-4">
            <button
              ...
              className="mt-2 px-8 py-3 bg-red-500/[15%] hover:bg-red-500/[25%] border border-red-500/[30%] hover:border-red-500/[50%] rounded-full text-xs font-black text-[color-mix(in_srgb,var(--danger)_80%,transparent)] uppercase tracking-[0.2em] transition-all duration-300 shadow-md hover:shadow-md"
            >
