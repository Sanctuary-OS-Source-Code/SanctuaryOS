                    ...
                    >
                      ...
                      <div className="flex flex-row items-start justify-between w-full gap-2 relative z-10">
                        ...
                        {inVault ? (
                          ...
                          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[color-mix(in_srgb,var(--subtext)_5%,transparent)] border border-[color-mix(in_srgb,var(--text)_10%,transparent)] rounded-lg shrink-0 shadow-sm group-hover/btn:border-[var(--accent)]/50 group-hover/btn:bg-[var(--accent)]/10 transition-colors">
                      ...
                      <div className="flex items-center justify-between w-full mt-auto relative z-10 pt-4 border-t border-[color-mix(in_srgb,var(--text)_5%,transparent)]">
                        ...
                        >
                          {copiedCode === bp.code ? (
                            ...
                            <>
                              <span className={`text-sm font-black tracking-[0.2em] uppercase ${inVault ? 'text-[var(--success)]' : 'text-[var(--text)] group-hover/code:text-[var(--accent)]'}`}>{bp.code}</span>
