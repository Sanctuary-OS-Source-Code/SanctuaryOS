          ...
          {!isDesktop() && isRootDomain() ? (
            <>
              <NavButton
                active={false}
                onClick={() => {
                  if (isRootDomain()) document.getElementById('workspaces')?.scrollIntoView({ behavior: 'smooth' });
              ...
              <NavButton
                active={false}
                onClick={() => {
                  if (isRootDomain()) document.getElementById('news')?.scrollIntoView({ behavior: 'smooth' });
              ...
              <NavButton
                active={false}
                onClick={() => {
                  if (isRootDomain()) document.getElementById('eula')?.scrollIntoView({ behavior: 'smooth' });
