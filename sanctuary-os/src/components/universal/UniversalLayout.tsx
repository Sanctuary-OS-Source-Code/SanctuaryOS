  ...
  const toggleNode = (
    <label className="relative inline-flex items-center cursor-pointer shrink-0">
      <input type="checkbox" className="sr-only peer" checked={checked} onChange={(e) => onChange(e.target.checked)} />
        <div className="w-11 h-6 bg-[color-mix(in_srgb,var(--text)_5%,transparent)] rounded-full peer peer-checked:bg-[color-mix(in_srgb,var(--accent)_20%,transparent)] peer-checked:border-[color-mix(in_srgb,var(--accent)_40%,transparent)] border border-[color-mix(in_srgb,var(--text)_5%,transparent)] transition-colors after:content-[''] after:absolute after:top-[1px] after:left-[1px] after:bg-[color-mix(in_srgb,var(--text)_40%,transparent)] after:border-[color-mix(in_srgb,var(--text)_10%,transparent)] after:border after:rounded-full after:h-[20px] after:w-[20px] after:transition-all peer-checked:after:translate-x-full peer-checked:after:border-white peer-checked:after:bg-[var(--accent)] shadow-[inset_0_2px_4px_rgba(0,0,0,0.2)]"></div>
    </label>
  );
