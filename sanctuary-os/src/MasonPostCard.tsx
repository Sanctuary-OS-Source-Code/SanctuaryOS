...
export default function MasonPostCard({ post, index, onPostClick, onToggleLike, onOpenMasonProfile, isFeatured, isCompact, layout, actions, hasUnsavedEdits }: any) {
  const { t } = useLexicon();
  ...
  return (
    <UniversalCard
      layout={layout || (isCompact ? "vertical-compact" : "vertical")}
      title={post.title}
