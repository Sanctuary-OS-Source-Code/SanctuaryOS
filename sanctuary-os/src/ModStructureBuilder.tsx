      ...
      >
        <div className="flex flex-col h-full overflow-hidden">
          <div className="px-8 py-6 shrink-0 border-b border-white/5 relative z-10">
            <input type="text" autoFocus placeholder={t("search_ph")} value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="w-full theme-glass-inner border border-white/10 rounded-xl text-[12px] font-mono text-[var(--text)] px-5 py-4 outline-none focus:theme-border-accent shadow-inner transition-all" />
          </div>
