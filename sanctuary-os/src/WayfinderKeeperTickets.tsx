...
interface WayfinderKeeperTicketsProps {
  userId?: string; // Optional: if provided, filter by specific user
  onSelectTicket?: (ticket: Ticket) => void;
  isSidePanel?: boolean;
}

export default function WayfinderKeeperTickets({ userId, onSelectTicket, isSidePanel = false }: WayfinderKeeperTicketsProps) {
  const { t } = useLexicon();
