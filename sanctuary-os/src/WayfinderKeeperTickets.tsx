      ...
      <div className="flex flex-col gap-4 border-b border-[color-mix(in_srgb,var(--text)_10%,transparent)] pb-4">
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            <h2 className="text-xl font-black uppercase tracking-widest">{t("your_tickets") || "Your Tickets"}</h2>
            <p className="text-sm text-[var(--subtext)]">{t("create_new") || "Manage or create new requests"}</p>
          </div>
        </div>
