      ...
      <div className="absolute inset-0 rounded-[inherit] flex z-10">
        <div className="flex-1 flex flex-col p-8 gap-10 overflow-y-auto custom-scrollbar pt-10 pb-32">
          ...
          <div className="p-8 flex flex-col gap-4 border" style={{
            ...
            <button className="px-6 py-3 mt-4 w-max text-[10px] font-black capitalize tracking-widest transition-all hover:scale-105 active:scale-95 border flex items-center justify-center gap-2 group" style={{
          ...
          <div className="flex flex-col gap-4">
            ...
            {['success', 'warning', 'danger'].map((sem) => (
              <div key={sem} className="p-5 border flex items-center gap-4" style={{
                ...
                <span className="text-xs font-black capitalize tracking-widest">{t(`color_${sem}`) || sem} {t("ui_status")}</span>
              </div>
            ))}
          </div>
