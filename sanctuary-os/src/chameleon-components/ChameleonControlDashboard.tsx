    ...
    <div className="flex-1 flex flex-col h-full border-r border-[color-mix(in_srgb,var(--text)_5%,transparent)] overflow-hidden">
      <div className="flex flex-col gap-4 px-6 pt-5 pb-0 border-b border-[color-mix(in_srgb,var(--text)_5%,transparent)] bg-transparent shrink-0">
        ...
        <div className="flex items-center gap-6 mt-4 overflow-x-auto custom-scrollbar">
          {[
            { id: 'colors', label: t("forge_tab_colors"), icon: 'palette' },
            { id: 'typography', label: t("forge_tab_typography"), icon: 'match_case' },
            { id: 'structure', label: t("forge_tab_structure"), icon: 'view_in_ar' },
            { id: 'backgrounds', label: t("forge_tab_backgrounds"), icon: 'wallpaper' }
          ].map(tab => (
            <button
              key={tab.id}
        ...
        {activeTab === 'backgrounds' && (
          <div className="flex flex-col gap-12 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="flex flex-col gap-6">
              <label className="text-[10px] font-black capitalize tracking-[0.2em] ml-1 text-[var(--subtext)] opacity-80">{t("forge_wallpaper_engine")}</label>
              ...
              <div className="flex flex-col gap-3 mt-4">
                <div className="flex items-center justify-between">
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <span className="text-[9px] font-black capitalize tracking-widest text-[var(--text)] opacity-80">{t("forge_bg_animated")}</span>
                ...
                <p className="text-[9px] text-[var(--subtext)] font-black capitalize tracking-widest ml-1 opacity-60">
                  {t("forge_bg_gradient_desc")}
                </p>
              </div>

              <div className="flex flex-col gap-4 mt-6 pt-6 border-t border-[color-mix(in_srgb,var(--text)_5%,transparent)]">
                <label className="text-[10px] font-black capitalize tracking-[0.2em] ml-1 text-[var(--subtext)] opacity-80">{t("forge_atmospheric_overrides")}</label>
                <div className="flex flex-col gap-3">
