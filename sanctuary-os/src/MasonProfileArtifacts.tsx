              ...
              footer={
                <div className="flex items-center justify-start w-full pt-1 relative min-h-[16px]">
                  ...
                  <div className="ml-auto pointer-events-none">
                    <span className="text-[10px] font-black theme-text-accent uppercase opacity-0 group-hover:opacity-100 transition-all translate-x-2 group-hover:translate-x-0 duration-300 relative z-10 pointer-events-auto" onClick={(e) => { e.stopPropagation(); onModClick({ ...mod, author: mason.name, isNexusView: true }); }}>
                        ...
                        {(mod.flavors || [])
                          ...
                          .map((flavor: any, subIdx: number) => (
                            <UniversalCard
                              ...
                              className="w-full h-full cursor-pointer hover:border-[var(--accent)]/[50%]"
                            />
                          ))}
                        </div>
                      </DeferredRender>
