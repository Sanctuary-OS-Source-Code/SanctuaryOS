...
export function DefconPanel() {
  ...
  return (
    <ElevatedHubLayout
      headerTitle={t("defcon_override_title") || "Global DEFCON Override"}
    ...
    >
      {activeTab === 'overview' && (
        <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className={`w-full max-w-xl mt-12 glass-panel border rounded-2xl p-8 flex flex-col items-center justify-center text-center gap-6 relative shrink-0 ${defconLevel === 1 ? 'border-amber-900/50 shadow-lg' : 'border-[color-mix(in_srgb,var(--text)_5%,transparent)]'}`}>
