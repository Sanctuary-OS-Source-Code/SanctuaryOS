    ...
    <div className="w-full xl:w-[320px] shrink-0 xl:sticky xl:top-0 space-y-6">
      ...
      <div className="flex flex-col gap-4">
        <button onClick={() => setIsBulkMode(!isBulkMode)} className={`w-full p-5 glass-panel border rounded-[var(--radius)] transition-all text-left group relative overflow-hidden flex items-center gap-4 ${isBulkMode ? 'bg-emerald-500/10 border-emerald-500/50' : 'border-[color-mix(in_srgb,var(--text)_5%,transparent)] hover:bg-[color-mix(in_srgb,var(--text)_5%,transparent)] hover:border-emerald-500/30'}`}>
          <div className={`w-12 h-12 rounded-xl glass-surface border flex items-center justify-center shrink-0 transition-colors ${isBulkMode ? 'bg-emerald-500/20 border-emerald-500/50 text-emerald-500' : 'border-emerald-500/30 group-hover:bg-emerald-500/10 text-emerald-500 shadow-md'}`}>
            <span className="material-symbols-outlined !text-3xl opacity-70 group-hover:scale-110 group-hover:opacity-100 transition-all duration-300 drop-shadow-md">{t("icon_checklist") || "checklist"}</span>
          </div>
          <div>
        ...
        <button onClick={() => setLocalFolderModal(true)} className="w-full p-5 glass-panel border border-[color-mix(in_srgb,var(--text)_5%,transparent)] rounded-[var(--radius)] hover:bg-[color-mix(in_srgb,var(--text)_5%,transparent)] hover:border-purple-500/30 transition-all text-left group relative overflow-hidden flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl glass-surface border flex items-center justify-center shrink-0 transition-colors border-purple-500/30 group-hover:bg-purple-500/10 text-purple-500 shadow-md">
            <span className="material-symbols-outlined !text-3xl opacity-70 group-hover:scale-110 group-hover:opacity-100 transition-all duration-300 drop-shadow-md">{t("icon_account_tree") || "account_tree"}</span>
          </div>
          <div>
        ...
        }} className="w-full p-5 glass-panel border border-[color-mix(in_srgb,var(--text)_5%,transparent)] rounded-[var(--radius)] hover:bg-[color-mix(in_srgb,var(--text)_5%,transparent)] hover:border-rose-500/30 transition-all text-left group relative overflow-hidden flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl glass-surface border flex items-center justify-center shrink-0 transition-colors border-rose-500/30 group-hover:bg-rose-500/10 text-rose-500 shadow-md">
            <span className="material-symbols-outlined !text-3xl opacity-70 group-hover:scale-110 group-hover:opacity-100 transition-all duration-300 drop-shadow-md">{t("icon_delete_sweep") || "delete_sweep"}</span>
          </div>
          <div>
        ...
        <button onClick={() => useStore.getState().setView("nexus")} className="w-full p-5 glass-panel border border-[color-mix(in_srgb,var(--text)_5%,transparent)] rounded-[var(--radius)] hover:bg-[color-mix(in_srgb,var(--text)_5%,transparent)] hover:border-amber-500/30 transition-all text-left group relative overflow-hidden flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl glass-surface border flex items-center justify-center shrink-0 transition-colors border-amber-500/30 group-hover:bg-amber-500/10 text-amber-500 shadow-md">
            <span className="material-symbols-outlined !text-3xl opacity-70 group-hover:scale-110 group-hover:opacity-100 transition-all duration-300 drop-shadow-md">{t("icon_auto_awesome") || "auto_awesome"}</span>
          </div>
          <div>
