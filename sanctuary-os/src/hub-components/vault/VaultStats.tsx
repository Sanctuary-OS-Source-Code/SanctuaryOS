...
export function VaultStats({ 
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      <div onClick={() => { setActiveCategory("all"); setFilterStatus("ALL"); setEquipFilter("ALL"); }} className="glass-panel rounded-[var(--radius)] p-4 flex flex-col justify-between cursor-pointer hover:border-[var(--text)] hover:bg-[color-mix(in_srgb,var(--text)_10%,transparent)] transition-all border border-[color-mix(in_srgb,var(--text)_30%,transparent)] bg-[color-mix(in_srgb,var(--text)_5%,transparent)] group">
      ...
      <div onClick={() => { setActiveCategory("equipped"); setEquipFilter("EQUIPPED"); }} className="glass-panel rounded-[var(--radius)] p-4 flex flex-col justify-between cursor-pointer hover:border-[var(--success)] hover:bg-emerald-500/[10%] transition-all border border-emerald-500/[30%] bg-emerald-500/[5%] group">
      ...
      <div onClick={() => { setActiveCategory("all"); setFilterStatus("unverified"); }} className="glass-panel rounded-[var(--radius)] p-4 flex flex-col justify-between cursor-pointer hover:border-[var(--warning)] hover:bg-orange-500/[10%] transition-all border border-orange-500/[30%] bg-orange-500/[5%] group">
