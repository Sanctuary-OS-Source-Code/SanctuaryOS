...
export const WorkbenchTemplateGuide: React.FC<WorkbenchTemplateGuideProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    <div className="glass-panel p-6 rounded-2xl border border-[color-mix(in_srgb,var(--accent)_20%,transparent)] bg-[color-mix(in_srgb,var(--accent)_5%,transparent)] relative shrink-0">
