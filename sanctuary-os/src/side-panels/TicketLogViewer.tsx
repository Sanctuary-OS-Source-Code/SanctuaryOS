        ...
        {sections.map((sec, idx) => {
          ...
          return (
            <div
              ...
              className="glass-panel group relative border border-[color-mix(in_srgb,var(--text)_10%,transparent)] hover:border-[color-mix(in_srgb,var(--accent)_40%,transparent)] transition-all duration-300 rounded-2xl shadow-lg bg-[color-mix(in_srgb,var(--bg)_50%,transparent)] cursor-pointer overflow-hidden min-h-[100px] flex flex-col items-start justify-center p-5"
            >
