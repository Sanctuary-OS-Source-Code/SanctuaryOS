...
export function SidePanelBrowserDownloads({ downloadsQueue, setDownloadsQueue }: { downloadsQueue: string[], setDownloadsQueue: React.Dispatch<React.SetStateAction<string[]>> }) {
  ...
  return (
  <div className="shrink-0 m-4 mt-0 glass-panel border-t border-[color-mix(in_srgb,var(--text)_10%,transparent)] shadow-[0_-20px_50px_rgba(0,0,0,0.5)] rounded-2xl p-4 flex flex-col gap-3 z-50 animate-in slide-in-from-bottom-10 backdrop-blur-3xl ">
