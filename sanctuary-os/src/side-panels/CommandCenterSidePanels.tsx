        ...
        <div className="px-1 py-2 shrink-0 flex flex-col gap-4 relative">
          <div className="flex items-center justify-between w-full relative z-10">
            ...
            {activeUpdates.length > 0 ? (
              ...
              <span className="text-[9px] font-black uppercase tracking-widest text-[var(--subtext)] opacity-40">0 {t("items")}</span>
            )}
          </div>
        </div>
                    ...
                    <div className="flex flex-col overflow-hidden">
                      ...
                      <div className="flex items-center gap-3 mt-1 flex-wrap">
                        <span className="text-[10px] font-bold tracking-widest text-[var(--subtext)] opacity-80 flex items-center">
                          {update.version} <span className="opacity-40 mx-2 text-[8px]">- </span> <span className="theme-text-accent font-black">{update.newVersion}</span>
                        </span>
