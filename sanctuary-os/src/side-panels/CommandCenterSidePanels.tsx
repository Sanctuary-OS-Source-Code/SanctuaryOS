      ...
      <div className="flex flex-col gap-4 w-full">
        ...
        <div className="flex flex-col gap-3 pb-24">
          {activeUpdates.length > 0 ? Object.values(activeUpdates.reduce((acc: any, update: any) => {
            ...
            <div key={update.hash || update.name} className="relative shrink-0 group/card w-full rounded-[var(--radius)] transition-all duration-500 border flex items-center border-[var(--accent)]/[30%] bg-[var(--accent)]/[5%] hover:bg-[var(--accent)]/[10%] shadow-lg hover:shadow-[0_0_30px_rgba(var(--accent-rgb),0.2)]">
              <div className="relative p-4 z-10 flex items-center gap-3 w-full">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0 border transition-all duration-500 shadow-inner border-[var(--accent)]/[50%] bg-[var(--accent)]/[10%] shadow-[0_0_15px_rgba(var(--accent-rgb),0.2)]">
