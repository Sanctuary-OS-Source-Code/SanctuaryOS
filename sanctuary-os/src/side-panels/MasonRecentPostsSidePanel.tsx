            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
                {posts.length === 0 ? (
                    <div className="flex flex-col justify-center items-center h-64 glass-panel rounded-2xl border border-[color-mix(in_srgb,var(--text)_5%,transparent)] shadow-xl group col-span-2">
                        <span className="material-symbols-outlined text-6xl mb-4 grayscale opacity-30 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-500 group-hover:scale-110 group-hover:-rotate-12">{t("icon_mail")}</span>
