      ...
      >
        {showDraftPrompt ? (
          <div className="flex-1 w-full h-full min-h-[500px] flex items-center justify-center p-8 animate-in fade-in zoom-in duration-500">
            <div className="glass-panel border border-[color-mix(in_srgb,var(--accent)_40%,transparent)] rounded-3xl p-10 flex flex-col gap-8 max-w-md w-full shadow-[0_20px_60px_-10px_rgba(var(--accent-rgb),0.2)] bg-black/40 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-6 w-full h-full">
          ...
          <div className="flex flex-col w-full mx-auto gap-6 pb-20 mt-4 max-w-4xl px-4">
            ...
            {error && (
              <div className="glass-panel border-l-4 border-l-[var(--danger)] border-y border-r border-[color-mix(in_srgb,var(--text)_10%,transparent)] rounded-2xl flex flex-col overflow-hidden relative shadow-md group">
            ...
            {vaultExtremeMods.length > 0 && (
              <div className="glass-panel border-l-4 border-l-[var(--danger)] border-y border-r border-[color-mix(in_srgb,var(--text)_10%,transparent)] rounded-2xl flex flex-col overflow-hidden relative shadow-md group shrink-0 mb-6">
                <div className="absolute inset-0 rounded-[inherit] bg-gradient-to-br from-[color-mix(in_srgb,var(--danger)_5%,transparent)] to-transparent pointer-events-none" />
                <div className="flex items-start gap-4 p-5 relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-[color-mix(in_srgb,var(--danger)_10%,transparent)] flex items-center justify-center shrink-0 border border-[color-mix(in_srgb,var(--danger)_30%,transparent)] text-[var(--danger)]">
            ...
            {activeCategory?.requires_target_mod && activeAdultMods.length > 0 && (
              <div className="glass-panel border-l-4 border-l-[var(--warning)] border-y border-r border-[color-mix(in_srgb,var(--text)_10%,transparent)] rounded-2xl flex flex-col overflow-hidden relative shadow-md group shrink-0 mb-6">
                        ...
                        {card.type === 'TELEMETRY' && (
                          <div className="flex flex-col gap-8">
                            ...
                            {String(activeCategory?.show_logs_box) !== "false" && (
                              <div className="w-full glass-panel rounded-2xl border border-[color-mix(in_srgb,var(--text)_10%,transparent)] p-1 min-h-[200px] flex flex-col relative overflow-hidden group">
