  ...
  return (
   ...
   <div className="relative z-10 w-[90%] max-w-lg glass-panel border border-[color-mix(in_srgb,var(--text)_10%,transparent)] rounded-2xl p-8 md:p-14 shadow-[0_40px_100px_rgba(0,0,0,0.4)] flex flex-col backdrop-blur-3xl group">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-10 relative z-20">
          ...
          <h1 className="text-4xl md:text-5xl font-black capitalize tracking-tighter text-[var(--headerText)] drop-shadow-md mb-2 transition-colors duration-500">
            {t("sidebar_app_title")}
          </h1>
          <p className="text-[10px] font-black capitalize tracking-[0.3em] theme-text-accent opacity-80 transition-colors duration-500">
            {t("subtitle")}
          </p>
        </div>
        ...
        <div className="mt-4 relative z-20">
          <button
            ...
            className="w-full py-3.5 rounded-xl font-black text-[10px] capitalize tracking-widest transition-all glass-surface border border-[color-mix(in_srgb,var(--text)_10%,transparent)] text-[var(--subtext)] hover:text-[var(--text)] hover:bg-[color-mix(in_srgb,var(--text)_5%,transparent)] hover:border-[color-mix(in_srgb,var(--text)_20%,transparent)] active:scale-[0.98]"
          >
            {t("btn_skip")}
          </button>
        </div>
