  ...
  return (
    <>
      <SidePanel
        isOpen={isOpen}
        onClose={onClose}
        title={t("ticket_support_desk") || "SUPPORT DESK"}
        ...
        footer={
          <div className="flex justify-end gap-4 w-full">
            ...
            >
              <span className="material-symbols-outlined !text-[14px]">{t("ui_icon_add_circle") || "add_circle"}</span> {t("ticket_new_ticket") || "NEW TICKET"}
            </button>
          </div>
        }
      >
